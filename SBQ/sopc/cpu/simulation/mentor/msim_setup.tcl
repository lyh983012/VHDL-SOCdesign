...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L CPU -L SYSID -L EPCS -L SDRAM -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L CPU -L SYSID -L EPCS -L SDRAM -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
