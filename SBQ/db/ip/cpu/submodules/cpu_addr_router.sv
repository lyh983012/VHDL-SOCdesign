...
(
    ...
    localparam PAD2 = log2ceil(64'h1880 - 64'h1860); 
    localparam PAD3 = log2ceil(64'h18a0 - 64'h1880); 
    localparam PAD4 = log2ceil(64'h18f8 - 64'h18f0); 
    localparam PAD5 = log2ceil(64'h1900 - 64'h18f8); 
    ...
    // ( 0x1860 .. 0x1880 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 25'h1860   ) begin
            src_channel = 12'b1000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x1880 .. 0x18a0 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 25'h1880   ) begin
            src_channel = 12'b0010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x18f0 .. 0x18f8 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 25'h18f0   ) begin
            src_channel = 12'b0001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x18f8 .. 0x1900 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 25'h18f8   ) begin
