...
SOPCINFO_FILE := Z:/Downloads/SBQ/cpu.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x18f0
SOPC_SYSID_FLAG += --sidp=0x18f0
ELF_PATCH_FLAG  += --sidp 0x18f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1545046699
SOPC_SYSID_FLAG += --timestamp=1545046699
ELF_PATCH_FLAG  += --timestamp 1545046699
